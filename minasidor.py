...
time.sleep(1)
# to select year
selectedYear = driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/mat-datepicker-content/mat-calendar/mat-calendar-header/div/div/button[1]').click()
# to select 2020
...
selectedYear = driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/mat-datepicker-content/mat-calendar/div/mat-month-view/table/tbody/tr[2]/td[1]/div').click()

# to select csv files
wait.until(presence_of_element_located((By.XPATH,'/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[4]/select')))
driver.find_element_by_xpath('/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[4]/select').click()

# to clicl on csv
wait.until(presence_of_element_located((By.XPATH,'/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[4]/select/option[3]')))
driver.find_element_by_xpath('/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[4]/select/option[3]').click()

# to download the report
wait.until(presence_of_element_located((By.XPATH,'/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[5]')))
...
#     selectedYear = driver.find_element_by_css_selector('/html/body/div[1]/div[2]/div/mat-datepicker-content/mat-calendar/mat-calendar-header/div/div/button[1]').click()
# #  to select Month
...
# # to select day
# driver.find_element_by_xpath('//*[@id="mat-datepicker-2"]/div/mat-month-view/table/tbody/tr[2]/td[2]/div]').click()
#
# wait.until(presence_of_element_located((By.XPATH,'/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[2]/mp-datepicker/input')))
# driver.find_element_by_xpath('/html/body/app-root/main/section/div/mp-reports-page/div[2]/div[1]/mp-reports/div/div/div[3]/div/div[2]/div[2]/mp-datepicker/input').click()
#
