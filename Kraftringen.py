...
driver.get("https://minasidor.kraftringen.se/default.aspx")
driver.maximize_window()

wait = WebDriverWait(driver, 30)

# to click on the Användarnamn username
driver.find_element_by_id('txtUser').send_keys('347601')

# to click on the Lösenord password
driver.find_element_by_id('txtPassword').send_keys('Kaffe2021')
...
wait.until(presence_of_element_located((By.XPATH, '/html/body/form/nav/div[2]/ul/li[11]/a')))
driver.find_element_by_xpath('/html/body/form/nav/div[2]/ul/li[11]/a').click()

# to select the Enga Rapport
wait.until(presence_of_element_located((By.XPATH, '/html/body/form/nav/div[2]/ul/li[11]/ul/li[3]/a')))
driver.find_element_by_xpath('/html/body/form/nav/div[2]/ul/li[11]/ul/li[3]/a').click()
